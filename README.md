...
## Webpage
- **Gene-based eQTL search**

  To search a gene's regulatory network — showing genes it regulates and those that regulate it — use the **gene symbol** (on Illumina’s Sentrix Human-6 Expression BeadChip) search at https://0jiawei0.github.io/eQTL-HapMapII/geqtl.html
  
- **SNP-based eQTL search**

  To search a marker's regulatory network — showing genes it regulates — use the **rsnumber** (on Affymetrix Human Mapping 500 K Set) search at https://0jiawei0.github.io/eQTL-HapMapII/seqtl.html
